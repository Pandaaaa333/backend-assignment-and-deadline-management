        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    request_paths = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_posts_subjects_subject_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_study_files", x => x.id);
                    table.ForeignKey(
                        name: "FK_study_files_subjects_subject_id",
                        column: x => x.subject_id,
                        principalTable: "subjects",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_study_files_users_user_id",
                        column: x => x.user_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    data_change = table.Column<string>(type: "text", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    user_id = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_users_subject", x => new { x.user_id, x.subject_id });
                    table.ForeignKey(
                        name: "FK_users_subject_subjects_subject_id",
                        column: x => x.subject_id,
                        principalTable: "subjects",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_users_subject_users_user_id",
                        column: x => x.user_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_study_logs_study_files_file_id",
                        column: x => x.file_id,
                        principalTable: "study_files",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_study_logs_users_user_id",
                        column: x => x.user_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_study_files_subject_id",
                table: "study_files",
                column: "subject_id");

            migrationBuilder.CreateIndex(
                name: "IX_study_files_user_id",
                table: "study_files",
                column: "user_id");

            migrationBuilder.CreateIndex(
                name: "IX_study_logs_file_id",
                table: "study_logs",
                column: "file_id");

            migrationBuilder.CreateIndex(
                name: "IX_study_logs_user_id",
                table: "study_logs",
                column: "user_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_users_subject_subject_id",
                table: "users_subject",
                column: "subject_id");
        }
